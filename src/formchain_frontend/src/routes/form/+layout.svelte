...
<div class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    >
      ...
      <div class="flex items-center">
        <ul
          ...
          data-tabs-toggle="#default-tab-content" data-tabs-active-classes="text-primary-600 border-b-2 border-primary-500" role="tablist"
        >
          <li
    ...
    <main id="default-tab-content" class="dark:bg-gray-900 flex-1 p-4 space-y-4">
        <slot/>
